...
export default function CobradorClientesPage() {
  ...
  useEffect(() => {
    if (status === "unauthenticated") {
      router.push("/login?callbackUrl=/mobile/cobrador/clientes");
    }
  }, [status, router]);
    ...
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200 px-4 pt-12 pb-4 sticky top-0 z-10">
          ...
          {offline && (
            <div className="mb-2 bg-amber-50 border border-amber-200 rounded-lg px-3 py-1.5 text-amber-700 text-xs font-medium flex items-center gap-2">
